#!/bin/bash -x
set -e
rsync -avr /Users/rafalrozestwinski/Desktop/3dp/gcode/ /Volumes/sambarr/3dprintsync/
ssh aux "bash -c 'cd /mnt/sda2_hot/samba/sambarr/3dprintsync && ./SYNC.sh'"
...
#fi
#
#sudo mount -t vfat -o rw,uid=1000,gid=1000 /dev/disk/by-uuid/$PART_UUID /mnt/3dp1/
